...
while(true)
	...
	System.out.println("------------------------------------------\n"
			...
			+ "------------------------------------------\n"
			+ "------------------------------------------");
	System.out.println("Developed by ABHISHEK KUMAR DANGI");
	System.out.println("------------------------------------------");
      ...
      switch(chr) {
      	...
      	case 2:
      		...
      		if(login(username,pwd)==1)
      		{
      			...
      			{
      				int choice;
      				System.out.println("  1. Add Files As URL");
      				System.out.println("  2. View Files As URL");
      				System.out.println("  3. Search Files As URL");
      				...
      				switch(choice) {
      				case 1:
      					System.out.println("Enter Your Files As url");
      					String url=sc.next();
      					if (isValid(url))
      					{
      				...
      				case 2:
      					...
      					break;
      				case 3:
      					System.out.println("Enter Your Files As url to search");
      					String url1=sc.next();
